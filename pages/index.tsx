        ...
        <section className='flex flex-col items-center justify-center mt-12 text-xs text-gray-500 dark:text-gray-300 leading-6'>
          ...
          <nav className='flex items-center justify-center mb-8'>
            ...
            <a
              target='_blank'
              rel='noopener noreferrer'
              href='https://x.com/bokibuilds'
              aria-label='Go To Bojan Tomic X Profile'
              title='X Profile'
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                ...
                fill='gray'
              >
                <path d='M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.627l-5.1-6.47-5.866 6.47h-3.31l7.732-8.835L.424 2.25h6.818l4.6 6.088 5.313-6.088zM17.534 20.908h1.885L6.456 3.75H4.471l13.063 17.158z'></path>
              </svg>
            </a>
          </nav>
        </section>
