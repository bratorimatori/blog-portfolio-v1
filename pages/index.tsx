    ...
    <div className='container flex items-center justify-center mx-auto max-w-4xl min-h-[61vh] px-4'>
      <section>
        <article>
          ...
          <p className='text-base text-gray-500 dark:text-gray-300 leading-9'>
            I like looking at the technical and product challenges from a higher
            level, cross-platform perspective. I do my best to help my team with
            analysing the advantages and disadvantages of the potential
            solutions to the problems we face.
          </p>
        </article>
        <div className='flex flex-row mt-4'>
          <div className='flex flex-row p-2 rounded-lg mr-4 bg-gray-100'>
