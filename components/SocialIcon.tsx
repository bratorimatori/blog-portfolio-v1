import type { SocialIcon as IconName } from '@/lib/site';
...
const PATHS: Record<IconName, string> = {
  ...
  x: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.627l-5.1-6.47-5.866 6.47h-3.31l7.732-8.835L.424 2.25h6.818l4.6 6.088 5.313-6.088zM17.534 20.908h1.885L6.456 3.75H4.471l13.063 17.158z',
};

/** RSS is drawn as strokes, the brand marks as fills. */
export function SocialIcon({ name }: { name: IconName }) {
  const isStroked = name === 'rss' || name === 'mail';
